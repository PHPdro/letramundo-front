...
const studentCurrentLevel = { name: 'Maria', level: 11, phase: 5 }
const studentHigherLevel = { name: 'Ana', level: 12, phase: 3 }

describe('ThemeSelection (nivel11/[theme]/page)', () => {
  beforeEach(() => {
    localStorage.clear()
  ...
  it('displays correct level heading', () => {
    ...
    expect(screen.getByText('Nível 11')).toBeInTheDocument()
  })
