  ...
  return (
    <div className={bgNiveisClass}>
      <div className="flex flex-col h-full p-3 sm:p-4 md:p-6">
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-medium text-center text-white mb-10 z-10">Nível 1</h1>
          ...
          {Array.from({ length: 10 }, (_, index) => (
            <Link href={`${theme}/jogo`} key={index}>
              <button
                ...
                className="w-[55px] h-[50px] sm:w-[70px] sm:h-[65px] p-2 rounded-full text-center items-center flex justify-center font-mono"
                style={{
                  backgroundColor:
