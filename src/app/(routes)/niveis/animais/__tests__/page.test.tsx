...
const studentLevel5 = { name: 'Carlos', level: 5 }

describe('Animais (niveis/animais/page)', () => {
  beforeEach(() => {
    localStorage.clear()
  })
  ...
  it('displays student name in welcome message', () => {
    ...
    expect(screen.getByText(/Bem vindo, Carlos!/)).toBeInTheDocument()
  })
  ...
  it('links each level to correct route with animais theme', () => {
    ...
    links.forEach((link, index) => {
      expect(link).toHaveAttribute('href', `/nivel${index + 1}/animais`)
    })
  })
