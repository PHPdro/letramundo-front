...
const Nivel5Cowboy = () => {
  ...
  const hardVowels = ["L", "O", "A", "V", "U", "F", "M", "I", "E"];
    ...
    <div className="h-screen bg-[#b6d5f0] bgCowBoyJogo">
      ...
      <div className="p-6">
        <div className="flex justify-between z-10">
          <BackButton url="nivel5/cowboy" color="orange" />
          <div>
      ...
      <div className="flex justify-center items-center w-full">
        {start ? (
          <div>
            ...
            <p className="text-center mb-2 text-xl font-bold">Nível 5 - Fase {phase}</p>
            {phase < 3 ? (
              <>
