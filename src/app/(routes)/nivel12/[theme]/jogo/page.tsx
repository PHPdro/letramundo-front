...
const Nivel12 = ({ params }: { params: { theme: string } }) => {
  const { theme } = params;
    ...
    <div className={`min-h-screen bg-[#b6d5f0] ${bgClass}`}>
      ...
      <div className="p-3 sm:p-4 md:p-6">
        <div className="flex justify-between z-10">
          <BackButton url={`nivel12/${theme}`} color={color} />
          <div>
            ...
            {phase < 3 ? (
              ...
              <div className="relative flex flex-col bg-white rounded-3xl min-h-[400px] md:min-h-[600px] m-3 p-5 z-10">
                <div>
                    ...
                    <div className="flex justify-center flex-col items-center w-full">
                      ...
                      <div className="flex flex-row mt-8 gap-3">
                        {correctStates.map((_, index) => (
                          <p className="border-[1px] border-black h-[50px] sm:h-[65px] md:h-[86px] text-center p-2 sm:p-3 md:p-5 lg:p-7 rounded-sm text-xl">
                  ...
                  <div
                    className={`flex flex-wrap justify-center items-center align-middle px-4 md:px-8 lg:px-32 mt-10 gap-7`}
                  >
                    {phase < 6
