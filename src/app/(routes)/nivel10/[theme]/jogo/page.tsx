...
const Nivel10 = ({ params }: { params: { theme: string } }) => {
  const { theme } = params;
    ...
    <div className={`min-h-screen bg-[#b6d5f0] ${bgClass}`}>
      ...
      <div className="p-3 sm:p-4 md:p-6">
        <div className="flex justify-between z-10">
          <BackButton url={`nivel10/${theme}`} color={color} />
          <div>
      ...
      <div className="flex justify-center items-center w-full">
        {start ? (
          <div>
            ...
            <p className="text-center mb-2 text-xl font-bold">Nível 10 - Fase {phase}</p>
            {phase < 3 ? (
              <>
