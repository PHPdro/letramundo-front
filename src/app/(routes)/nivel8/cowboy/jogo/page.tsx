...
import { getCowboyImage } from "@/utils/getCowboyImage";
...
const Nivel8Cowboy = () => {
  ...
  const hardVowels = ["P", "N", "I", "J", "E", "L", "O", "A", "V", "M", "U"];
    ...
    <div className="h-screen bg-[#b6d5f0] bgCowBoyJogo">
      ...
      <div className="p-6">
        <div className="flex justify-between z-10">
          <BackButton url="nivel8/cowboy" color="orange" />
          <div>
      ...
      <div className="flex justify-center items-center w-full">
        {start ? (
          <div>
            ...
            <p className="text-center mb-2 text-xl font-bold">Nível 8 - Fase {phase}</p>
            {phase < 3 ? (
              <>
                ...
                <div>
                  <div className="flex flex-col justify-center items-center w-full">
                    ...
                    <div className="flex justify-center flex-col items-center w-full">
                      <img
                        src={getCowboyImage(phases[phase - 1][stage][0].letter)}
