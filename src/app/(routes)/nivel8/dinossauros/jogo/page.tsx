...
const Nivel8Dinossauros = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setStage(0);
      setTimeout(() => {
        router.push("/nivel8/dinossauros");
  ...
  return (
    <div className="h-screen bg-[#b6d5f0] bgDinosJogo">
      {isCorrect && <Confetti width={window.innerWidth || 300} height={window.innerHeight || 200} />}
      <div className="p-6">
        <div className="flex justify-between z-10">
          <BackButton url="nivel8/dinossauros" color="blue" />
          <div>
...
export default Nivel8Dinossauros;
