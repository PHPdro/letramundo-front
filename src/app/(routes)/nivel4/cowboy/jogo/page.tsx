...
const Nivel4Cowboy = () => {
  ...
  const hardVowels = ["L", "O", "A", "U", "I", "V", "F", "E"];
    ...
    <div className="h-screen bg-[#b6d5f0] bgCowBoyJogo">
      ...
      <div className="p-6">
        <div className="flex justify-between z-10">
          <BackButton url="nivel4/cowboy" color="orange" />
          <div>
      ...
      <div className="flex justify-center items-center w-full">
        {start ? (
          <div>
            ...
            <p className="text-center mb-2 text-xl font-bold">Nível 4 - Fase {phase}</p>
            {phase < 3 ? (
              <>
