...
const studentCurrentLevel = { name: 'Maria', level: 9, phase: 5 }
const studentHigherLevel = { name: 'Ana', level: 10, phase: 3 }

describe('ThemeSelection (nivel9/[theme]/page)', () => {
  beforeEach(() => {
    localStorage.clear()
  ...
  it('displays correct level heading', () => {
    ...
    expect(screen.getByText('Nível 9')).toBeInTheDocument()
  })
