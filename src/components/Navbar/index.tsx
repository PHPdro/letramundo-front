      ...
      <div className="max-w-7xl mx-auto py-4 md:py-8 px-2">
        <div className="flex justify-between items-center h-16">
          <div className="flex space-x-4 items-center">
            <Image className="mr-5 w-[60px] h-[60px] md:w-[100px] md:h-[100px]" src="/LetraMundo.png" alt="logo" width={100} height={100} />
          ...
          <div className="flex items-center">
            <span className="hidden md:inline text-gray-700 px-3 py-2 rounded-md text-base font-medium">Professor</span>
